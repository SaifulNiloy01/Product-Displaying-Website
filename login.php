...
<body>
<form action="insert_or_delete.php" method="POST" class="login">
    <h1>NR ComputerShop</h1>
    <input type="text" name="user_name" class="login-input" placeholder="User Name" autofocus>
